...
const { sendEmail } = require('../Mailsend/appoint_mailsender'); // Import the email sending function
    ...
    createAppointment: (req, res) => {
        ...
        Appointment.create(appointmentData, (error, results) => {
            ...
            const sendEmails = async () => {
                try {
                    await sendEmail(clientRecipient,userRecipient, subjectUser, appointmentData, 'userside_style');
